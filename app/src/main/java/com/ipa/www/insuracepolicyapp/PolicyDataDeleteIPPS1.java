...
public class PolicyDataDeleteIPPS1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        policyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(PolicyDataDeleteIPPS1.this, databaseError.getCode(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        DDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PolicyDataDeleteIPPS1.this, "Delete Successsful", Toast.LENGTH_SHORT);

                finish();

                startActivity(new Intent(PolicyDataDeleteIPPS1.this, ProvidersHome.class));
            }
        });
    }
