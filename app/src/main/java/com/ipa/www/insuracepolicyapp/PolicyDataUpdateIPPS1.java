...
public class PolicyDataUpdateIPPS1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        policyRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(PolicyDataUpdateIPPS1.this, databaseError.getCode(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        UUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(PolicyDataUpdateIPPS1.this, "Update Successsful", Toast.LENGTH_SHORT);
